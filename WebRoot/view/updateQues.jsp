				...
				<tr>
					...
					<td>
						<input type="text" name="<%= txtname %>" id="<%= txtname %>"
							value="<%=sel.getContent()%>" style="width:260px;"/> 分数：<input type="text" name="<%= scorename %>" id="<%= scorename %>"
							value="<%= sel.getRemark()%>" style="width:15%;"/>
							<br />
					</td>
				</tr>
					<%
