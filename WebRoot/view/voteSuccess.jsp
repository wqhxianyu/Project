...
<%
	...
	ObjectBean ob = ObjectBeanService.findObjectBeanByID(oid);//取得问卷详细信息
	...
	Enumeration e = request.getParameterNames();	//获取发送请求的表单的所有name属性
	List lname = new LinkedList();					//创建链表
	...
	replay.setReplayTime(currentTime);
	//取得参数的值
	for (int i = 0; i < lname.size(); i++) {
		...
		if (name.startsWith("check")) {
			...
			if (checkbox != null) {
				...
				int seSeq = Integer.parseInt(cValue);	//取得选择的是哪个选项
